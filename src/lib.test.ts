...
test("'>=' operator", () => {
  expect(nixrt.greater_eq(1, 0)).toBe(true);
  expect(nixrt.greater_eq(1, 1)).toBe(true);
  expect(nixrt.greater_eq(1, 2)).toBe(false);
});

test("'>' operator", () => {
  expect(nixrt.greater(1, 0)).toBe(true);
  expect(nixrt.greater(1, 1)).toBe(false);
  expect(nixrt.greater(1, 2)).toBe(false);
});
